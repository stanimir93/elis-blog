            ...
            <Header className='bg-dark text-light' articles={articles}/>
                <div className='d-md-flex height-main position-relative'>
                    ...
                    <main className='p-5 container-fluid'>
                        <Routes>
                            <Route path="/" element={<Home articles={articles} setSearchResults={customSetSeachResults} searchVal={searchVal} setSearchVal={setSearchVal}/>}/>
                            <Route path="/about" element={<About articles={articles}/>}/>
                            <Route path="/blog-posts" element={<Articles articles={articles}/>}/>
                            <Route path="/article/:id" element={<Article articles={articles}/>}/>
                            <Route path="/inspirations" element={<Inspirations foundArticles={searchResults}/>} />
                            <Route path="/contact" element={<Contact foundArticles={searchResults}/>} />
                            <Route path="/search" element={<Search foundArticles={searchResults} articles={articles} setSearchResults={customSetSeachResults} term={term} searchVal={searchVal} setSearchVal={setSearchVal}/>} />
